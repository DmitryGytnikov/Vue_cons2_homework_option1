...
<template>
  ...
  >
    ...
    <todo-big-card1
      @change-click-state="changeClickState()"
      @change-hover-state="changeHoverState()"
...
<script lang="ts">
// import TodoBigCard from "./TodoBigCard.vue"
import TodoBigCard1 from "./TodoBigCard1.vue";
